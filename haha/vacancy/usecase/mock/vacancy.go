...
func (m *MockVacancyUseCase) GetVacancies() ([]models.Vacancy, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVacancyUseCaseMockRecorder) GetVacancies() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVacancies", reflect.TypeOf((*MockVacancyUseCase)(nil).GetVacancies))
}
