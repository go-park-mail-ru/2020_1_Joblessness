...
func (m *MockSummaryRepository) GetOrgSummaries(arg0 uint64) (models.OrgSummaries, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSummaryRepositoryMockRecorder) GetOrgSummaries(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrgSummaries", reflect.TypeOf((*MockSummaryRepository)(nil).GetOrgSummaries), arg0)
}
