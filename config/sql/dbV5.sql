...
ALTER TABLE public.favorite ADD CONSTRAINT unique_like UNIQUE (user_id, favorite_id);

ALTER TABLE public.response ADD CONSTRAINT unique_response UNIQUE (summary_id, vacancy_id);
